...
parent_of_filedir = dirname(os.path.abspath(__file__))
sys.path.append(parent_of_filedir)
...
sys.path.append(dirname(parent_of_filedir))
...
def pipeline_main(config_path: str, csv_path: str, expt_name: str):
    """Run the multiomics pipeline

    Args:
        config_path (str): Path to yaml file
        csv_path (str): Path to data csv
        expt_name (str): experiment name and save name
